...
% Visualization for Proposed Method across maps
\begin{figure}[H]
    \centering
    \begin{subfigure}[b]{0.45\textwidth}
        \centering
        \includegraphics[width=\linewidth]{images/Propose/visu-map1-m8-proposed_method_full.png}
        \caption{Map a - Proposed Method (Full)}
    \end{subfigure}
    \hfill
    \begin{subfigure}[b]{0.45\textwidth}
        \centering
        \includegraphics[width=\linewidth]{images/Propose/visu-map3-m8-proposed_method_full.png}
        \caption{Map b - Proposed Method (Full)}
    \end{subfigure}
    \caption{Visualization of paths with the Proposed Method (Full) on Maps a and b.}
    \label{fig:proposed-path-visualization-map1-3}
\end{figure}
...
\begin{figure}[H]
    ...
    \begin{subfigure}[b]{0.45\textwidth}
        \centering
        \includegraphics[width=\linewidth]{images/Propose/visu-map7-m8-proposed_method_full.png}
        \caption{Map c - Proposed Method (Full)}
    \end{subfigure}
    \hfill
    \begin{subfigure}[b]{0.45\textwidth}
        \centering
        \includegraphics[width=\linewidth]{images/Propose/visu-map8-m8-proposed_method_full.png}
        \caption{Map d - Proposed Method (Full)}
    \end{subfigure}
    \caption{Visualization of paths with the Proposed Method (Full) on Maps c and d.}
    \label{fig:proposed-path-visualization-map8-7}
\end{figure}
