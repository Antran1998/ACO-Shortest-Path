...
The smoothing algorithm was applied to the discrete paths generated in four maps. As summarized in Table~\ref{tab:results_smoothing}, the post-processing step consistently reduced the path length while preserving collision-free trajectories.
...
\hline
\textbf{Map Name} & \textbf{Discrete (m)} & \textbf{Smoothed (m)} & \textbf{Reduction (m)} & \textbf{Improvement (\%)} \\
\hline
Map a & 5.24 & 5.22 & 0.02 & 0.38\% \\
\hline
Map b & 50.94 & 49.29 & 1.65 & 3.24\% \\
\hline
Map c & 49.14 & 48.36 & 0.78 & 1.59\% \\
\hline
Map d & 22.97 & 22.03 & 0.94 & 4.09\% \\
\hline
\end{tabular}
\end{table}
...
\begin{subfigure}[b]{0.48\textwidth}
\includegraphics[width=\textwidth]{images/visu-map7-m6-path_smoothing_o5.png}
\caption{Map c}
\end{subfigure}
\hfill
\begin{subfigure}[b]{0.48\textwidth}
