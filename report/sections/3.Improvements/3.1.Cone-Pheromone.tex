...
\begin{figure}[H]
    ...
    \begin{subfigure}[b]{0.45\textwidth}
        \centering
        \includegraphics[width=\linewidth]{images/O1/visu-map1-m3-cone_pheromone_o1.png}
...
\begin{figure}[H]
    ...
    \begin{subfigure}[b]{0.45\textwidth}
        \centering
        \includegraphics[width=\linewidth]{images/O1/visu-map3-m3-cone_pheromone_o1.png}
...
\begin{figure}[H]
    ...
    \begin{subfigure}[b]{0.45\textwidth}
        \centering
        \includegraphics[width=\linewidth]{images/O1/visu-map8-m3-cone_pheromone_o1.png}
...
\begin{figure}[H]
    ...
    \begin{subfigure}[b]{0.45\textwidth}
        \centering
        \includegraphics[width=\linewidth]{images/O1/visu-map7-m3-cone_pheromone_o1.png}
...
\begin{table}[H]
    ...
    \begin{tabular}{|c|c|c|c|}
        ...
        \hline
        \multirow{2}{*}{map a (Simple)} & Basic ACO & 6.04 $\pm$ 0.54 & 0.166 \\
         & Cone Pheromone (O1) & 5.24 $\pm$ 0.00 & 0.213 \\
        \hline
        \multirow{2}{*}{map b (Cluttered)} & Basic ACO & 89.15 $\pm$ 7.56 & 5.766 \\
         & Cone Pheromone (O1) & 49.58 $\pm$ 1.59 & 4.075 \\
        \hline
        \multirow{2}{*}{map c (Crowded)} & Basic ACO & 37.30 $\pm$ 2.06 & 2.158 \\
         & Cone Pheromone (O1) & 23.26 $\pm$ 0.34 & 1.469 \\
        \hline
        \multirow{2}{*}{map d (Maze-like)} & Basic ACO & 85.11 $\pm$ 10.29 & 5.603 \\
