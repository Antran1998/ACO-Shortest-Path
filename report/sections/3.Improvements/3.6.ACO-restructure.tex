...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.95\linewidth]{images/O6/basic_flow.webp}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.95\linewidth]{images/new_flow.png}
...
\begin{table}[H]
    ...
    \begin{tabular}{|c|c|c|c|}
        ...
        \hline
        \multirow{2}{*}{map a (Simple)} & Basic ACO & 6.12 $\pm$ 0.67 & 0.302 \\
         & New Algorithm Flow (O6) & 5.24 $\pm$ 0.00 & 0.276 \\
        \hline
        \multirow{2}{*}{map b (Cluttered)} & Basic ACO & 88.52 $\pm$ 8.51 & 5.130 \\
         & New Algorithm Flow (O6) & 82.83 $\pm$ 20.03 & 5.729 \\
        \hline
        \multirow{2}{*}{map c (Crowded)} & Basic ACO & 36.63 $\pm$ 2.35 & 1.830 \\
         & New Algorithm Flow (O6) & 23.96 $\pm$ 1.13 & 1.392 \\
        \hline
        \multirow{2}{*}{map d (Maze-like)} & Basic ACO & 86.47 $\pm$ 10.85 & 5.004 \\
...
O6 achieves shorter mean paths (82.83) but with higher variance (±20.03) and a modest runtime increase (5.729 s) compared to Basic (88.52 ± 8.51, 5.130 s), reflecting exploration–exploitation trade-offs.

\subsubsection*{\textbullet\ Crowded Environment (Map c)}
Clear improvements: 23.96 ± 1.13 vs. 36.63 ± 2.35, with faster execution (1.392 s vs. 1.830 s), indicating efficient convergence.

\subsubsection*{\textbullet\ Maze-like Environment (Map d)}
Substantial gains: 60.91 ± 8.51 vs. 86.47 ± 10.85, and faster runtime (2.978 s vs. 5.004 s), highlighting robustness in complex layouts.

\subsubsection*{Summary and Insights}
The ACO restructuring (O6) provides a stable backbone that, by clarifying control flow and failure recovery, improves mean path length and runtime in most environments. Variance may increase in cluttered scenes due to broader exploration, but overall reliability and efficiency benefit from the reorganized loop and termination logic.