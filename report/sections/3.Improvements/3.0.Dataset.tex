...
\begin{itemize}
  ...
  \item \textbf{Map c (Maze-like):} $16 \times 16$ grid with clustered obstacles and multiple viable routes, testing the algorithm's ability to discover diverse solution paths.
  \item \textbf{Map d (Crowded):} $25 \times 20$ grid with moderate obstacle density and mixed open/constrained regions, representing intermediate difficulty.
\end{itemize}
